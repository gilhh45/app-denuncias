...
export default function NovaDenunciaScreen() {
  ...
  const credScore = useMemo(
    () => calcCredScore(description, files, url),
  ...
  async function pickImages() {
    ...
    if (status !== "granted") {
      Alert.alert(
        ...
        "Precisamos de acesso às suas fotos para anexar evidências.",
      );
      return;
    }
  ...
  function handleSubmit() {
    ...
    if (parseInt(captchaInput) !== captcha.answer) {
      setError("Resposta da verificação incorreta.");
      return;
    }
      ...
      >
        ...
        <View
          style={[
            ...
            { backgroundColor: c.bg, borderBottomColor: c.divider },
          ]}
        >
          <TouchableOpacity
            onPress={() => router.back()}
        ...
        {(isRateLimited || inCooldown) && (
          <View style={styles.rateBanner}>
            ...
            <Text style={styles.rateText}>
              {isRateLimited
                ? "Limite de 3 denúncias/hora atingido."
                  ...
                  >
                    <Text
                      style={[
                        ...
                        { color: platform === p ? c.bg : c.textMuted },
                      ]}
                    >
                      {p}
                    </Text>
        ...
        <View style={styles.field}>
          <View style={styles.fieldLabelRow}>
            ...
            <Text
              style={[
                styles.charCount,
                { color: description.length < 20 ? c.primary : "#00694d" },
              ]}
            >
        ...
        <View style={styles.field}>
          ...
          >
            ...
            <Text style={[styles.uploadTitle, { color: c.text }]}>
              Toque para anexar prints
            </Text>
            <Text style={[styles.uploadSub, { color: c.textMuted }]}>
              JPG, PNG máx 5MB
            </Text>
          </TouchableOpacity>
          {files.map((f, i) => (
            ...
            >
              ...
              <Text
                style={[styles.fileName, { color: c.textMuted }]}
                numberOfLines={1}
              >
                {f.split("/").pop()}
              </Text>
        ...
        >
          <View style={styles.scoreHeader}>
            <View>
              <Text style={[styles.scoreTitle, { color: c.textMuted }]}>
                Score de Impacto
              </Text>
              <View
                style={{ flexDirection: "row", alignItems: "baseline", gap: 2 }}
              >
                <Text style={[styles.scoreNum, { color: c.primary }]}>
                  {credScore}
                </Text>
                <Text style={[styles.scoreTotal, { color: c.textMuted }]}>
                  /100
                </Text>
              </View>
            </View>
          ...
          <View style={[styles.progressBg, { backgroundColor: c.divider }]}>
            <View
              style={[
                styles.progressFill,
                { width: `${credScore}%`, backgroundColor: c.primary },
              ]}
            />
          </View>
          <View
            style={[
              styles.scoreHint,
              { backgroundColor: c.card, borderLeftColor: c.primary },
            ]}
          >
        ...
        <View
          style={[
            styles.captchaBox,
            { backgroundColor: c.divider, borderColor: c.inputBorder },
          ]}
        >
          ...
          <View style={{ flex: 1, gap: 8 }}>
            ...
            <View style={styles.captchaRow}>
              <Text style={[styles.captchaQuestion, { color: c.text }]}>
                {captcha.a} + {captcha.b} =
              </Text>
              <TextInput
                style={[
        ...
        <View style={{ gap: 6 }}>
          <TouchableOpacity
            style={[
              ...
              {
                backgroundColor:
                  isRateLimited || inCooldown ? c.divider : c.primary,
          ...
          >
            <Text
              style={[
                styles.submitLabel,
                { color: isRateLimited || inCooldown ? c.textMuted : "#fff" },
              ]}
            >
              ENVIAR DENÚNCIA
            </Text>
