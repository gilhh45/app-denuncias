    ...
    <ScrollView style={[styles.root, { backgroundColor: c.bg }]} contentContainerStyle={styles.scroll}>
      ...
      <View style={[styles.userCard, { backgroundColor: c.card, borderColor: c.border }]}>
        ...
        <View style={{ gap: 2 }}>
          ...
          <Text style={[styles.anonLabel, { color: c.textMuted }]}>Denunciante Anônimo</Text>
        </View>
      </View>

      {/* Credibility */}
      <View style={[styles.credRow, { backgroundColor: c.card, borderColor: c.border }]}>
      ...
      <TouchableOpacity
        ...
        onPress={toggle}
      >
        <Feather name={theme === 'light' ? 'moon' : 'sun'} size={18} color={c.text} />
      ...
      <View style={styles.footer}>
        ...
        <Text style={[styles.footerText, { color: c.textMuted }]}>SYSTEM SECURE · DADOS PROTEGIDOS</Text>
      </View>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  avatarLetter: { fontFamily: 'HankenGrotesk_700Bold', fontSize: 22, color: '#fff' },
  ...
  footerText: { fontFamily: 'JetBrainsMono_700Bold', fontSize: 11, letterSpacing: 1.2 },
});
